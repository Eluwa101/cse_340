...
-- Table structure for accounts table
...
-- Table structure for account_favorites table
-- DROP TABLE IF EXISTS public.account_favorites;
CREATE TABLE IF NOT EXISTS public.account_favorites (
favorite_id INT GENERATED BY DEFAULT AS IDENTITY,
account_id INT NOT NULL,
inv_id INT NOT NULL,
created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
CONSTRAINT account_favorites_pk PRIMARY KEY (favorite_id),
CONSTRAINT account_favorites_unique UNIQUE (account_id, inv_id),
CONSTRAINT fk_favorite_account FOREIGN KEY (account_id)
  REFERENCES public.account (account_id) match simple
  ON UPDATE CASCADE
  ON DELETE CASCADE,
CONSTRAINT fk_favorite_inventory FOREIGN KEY (inv_id)
...
-- Table structure for food_order table
...
created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
CONSTRAINT food_order_pk PRIMARY KEY (order_id),
CONSTRAINT fk_order_inventory FOREIGN KEY (inv_id)
  REFERENCES public.inventory (inv_id) match simple
  ON UPDATE CASCADE
  ON DELETE CASCADE
);
